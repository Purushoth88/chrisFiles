...
import org.eclipse.jgit.storage.file.FileRepositoryBuilder;
	...
	public class TestLocalRepo {
		...
		public static void main(String args[]) throws GitAPIException,
				JGitInternalException, IOException, NoWorkTreeException, InterruptedException {
		...
		public void test(Git repo) throws GitAPIException, JGitInternalException,
				NoWorkTreeException, CorruptObjectException, IOException {
			for (RevCommit c : repo.log().call())
				System.out.println("found commit: " + c.getName() + ": "
						+ c.getShortMessage());
			DirCache dc = repo.getRepository().readDirCache();
			System.out.println("found " + dc.getEntryCount()
					+ " entries in the dircache");
		}
