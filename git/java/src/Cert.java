...
public class Cert {
  ...
  public static void main(String[] args) throws IOException,
    ...
    loadPrivateKey(readRaw("C:/certs/ca.key.pk8"), "caKeyPasswd".toCharArray());
    loadPrivateKey(readPEM("C:/certs/ca.key.pem"), "caKeyPasswd".toCharArray());
  ...
  public static void listWindowsRoot() throws GeneralSecurityException,
    ...
    while (en.hasMoreElements()) {
      ...
      if (aliasKey.equals("myKey")) {
        PrivateKey key =
            (PrivateKey) ks.getKey(aliasKey, "monPassword".toCharArray());
  ...
  public static void loadPrivateKey(byte[] data, char[] password)
    ...
    SecretKey encryptedKey =
        SecretKeyFactory.getInstance(epki.getAlgName()).generateSecret(keySpec);
