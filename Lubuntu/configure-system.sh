...
if ! grep "^no_proxy" /etc/environment ;then
	sudo sh -c "echo 'no_proxy=.wdf.sap.corp,nexus,jtrack,127.0.0.1,localhost,git.wdf.sap.corp' >> /etc/environment"
fi
export http_proxy=http://proxy:8080
export https_proxy=https://proxy:8080
export no_proxy=.wdf.sap.corp,nexus,jtrack,127.0.0.1,localhost,git.wdf.sap.corp
